	 	...
	 	<form id="mfm" method="post">
	 		<table cellspacing="8px">
	 			...
	 			<tr>
	 				...
	 				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	 				<td></td>
	 				<td><input type="hidden" id="password" name="password" class="easyui-validatebox easyui-textbox" required="true" value="${usermessage.password }"/>&nbsp;</td>
	 			</tr>
	 		</table>
	 	</form>
	</div>
