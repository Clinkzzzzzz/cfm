...
<script>
	function searchLine(){
		...
		$.post("${basePath}produceIncomeType.do", {incomer : s_user,starttime:s_starttime,endtime:s_endtime,roleid:"1",userid:"1"}, function(result) {
		...
		$.post("${basePath}producePayType.do", {payer : s_user,starttime:s_starttime,endtime:s_endtime,roleid:"1",userid:"1"}, function(result) {
